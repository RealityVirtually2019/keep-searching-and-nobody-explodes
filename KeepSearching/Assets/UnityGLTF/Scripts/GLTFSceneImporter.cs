...
namespace UnityGLTF
{
    ...
    public class GLTFSceneImporter
    {
        ...
        public GLTFSceneImporter(GLTFRoot rootNode, ILoader externalDataLoader, AsyncCoroutineHelper asyncCoroutineHelper, Stream glbStream = null) : this(externalDataLoader, asyncCoroutineHelper)
        {
            _gltfRoot = rootNode;
            if (glbStream != null)
            {
        ...
        {
            if (_gltfRoot == null || _gltfRoot.Meshes == null)
            {
                yield break;
            }
            int meshTotal = _gltfRoot.Meshes.Count;
